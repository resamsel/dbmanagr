...
from .writer import SqlInsertWriter, SqlUpdateWriter, SqlDeleteWriter, YamlWriter, FormattedWriter
...
group.add_argument('-F', '--formatted', help='output format: given with the -f/--format option', dest='formatter', action='store_const', const=FormattedWriter)
...
parser.add_argument('-f', '--format', default=u'{0}', help='the format for the -F/--formatted writer')
