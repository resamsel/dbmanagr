...
parser.add_argument('left',
    help='the left URI to parse (format for PostgreSQL/MySQL: user@host/database/table; '
        'for SQLite: databasefile.db/table)')
parser.add_argument('right',
    help='the right URI to parse (format for PostgreSQL/MySQL: user@host/database/table; '
        'for SQLite: databasefile.db/table)')
parser.add_argument('-v',
    '--verbose',
    action='count',
    help='specify the verbosity of the output, increase the number of occurences of this option'
...
# parser.add_argument('-i', '--include', help='include the specified columns and their foreign rows, '
#    'if any (multiple columns can be specified by separating them with a comma)')
